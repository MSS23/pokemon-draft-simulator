...
export const POKEMON_FORMATS: PokemonFormat[] = [
  ...
  // Pokemon Champions Regulation M-A. The official allowlist is authoritative;
  // broad category rules must never expand this pool.
  {
    id: 'vgc-reg-ma',
    name: 'Pokemon Champions Regulation M-A',
    shortName: 'Champions M-A',
    description: 'Official Pokemon Champions M-A pool (Apr 8-Jun 17, 2026): 186 draftable species, item clause, and one Mega Evolution per battle.',
    generation: 9,
    gameType: 'doubles',
    category: 'vgc',
    ruleset: {
      ...
      itemClause: true,
      bannedPokemon: [],
      allowedPokemon: CHAMPIONS_MA_DEX_IDS,
      bannedTiers: [],
      allowedGenerations: [],
    ...
    meta: {
      ...
      season: 'Pokemon Champions Regulation M-A',
      source: 'https://champions-news.pokemon-home.com/en/page/751.html',
      popularity: 5,
      complexity: 4,
    },
  },

  // Pokemon Champions Regulation M-B: M-A plus the 22 species announced for
  // the June 2026 regulation update.
  {
    id: 'vgc-reg-mb',
    ...
    ruleset: {
      ...
      itemClause: true,
      bannedPokemon: [],
      allowedPokemon: CHAMPIONS_MB_DEX_IDS,
      bannedTiers: [],
      allowedGenerations: [],
      legendaryPolicy: 'allowed',
      mythicalPolicy: 'allowed',
