            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-center px-6">
                {match.status === 'completed' ? (
                  ...
                  <div className="text-xl font-bold tracking-wider text-muted-foreground">VS</div>
                )}
                <Badge
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-4">
                <div className="text-center flex-1">
                  <div className="text-3xl font-bold tracking-tight tabular-nums text-green-500">{h2h.wins}</div>
                  <div className="text-xs text-muted-foreground">Wins</div>
                </div>
                <div className="text-center flex-1">
                  <div className="text-3xl font-bold tracking-tight tabular-nums text-gray-400">{h2h.draws}</div>
                  <div className="text-xs text-muted-foreground">Draws</div>
                </div>
                <div className="text-center flex-1">
                  <div className="text-3xl font-bold tracking-tight tabular-nums text-red-500">{h2h.losses}</div>
