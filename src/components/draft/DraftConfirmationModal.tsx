          ...
          <div className="relative p-4 sm:p-6 md:p-8 text-center">
            ...
            <div className="relative z-10">
              <DialogHeader className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                <DialogTitle className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-white flex items-center justify-center gap-2">
                  <Sparkles className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />
                  <span className="truncate">Draft Confirmation</span>
                  <Sparkles className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />
                </DialogTitle>
                <DialogDescription className="text-sm sm:text-base text-slate-600 dark:text-slate-400 px-2">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-700 rounded-full p-4 sm:p-6 md:p-8 border-2 border-slate-200 dark:border-slate-600 shadow-xl">
                    {!imageError ? (
                      ...
                      <div className="w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] md:w-[140px] md:h-[140px] flex items-center justify-center">
              ...
              {/* Pokemon Info */}
              <div className="space-y-3 sm:space-y-4 md:space-y-5 px-2">
                <div>
                  <h3 className="text-2xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-3 capitalize truncate">
                    {pokemon.name}
                  </h3>
                ...
                {/* Cost Analysis */}
                <div className="bg-white dark:bg-slate-800 rounded-xl p-3 sm:p-4 md:p-5 space-y-2 sm:space-y-3 shadow-lg border border-slate-200 dark:border-slate-700">
                  <div className="flex items-center justify-between py-1.5 sm:py-2">
                    <span className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">Draft Cost:</span>
                    <div className="flex items-center gap-1 sm:gap-2">
                      <Badge
                        className={cn(
                          "font-bold px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 text-xs sm:text-sm shadow-md",
                      ...
                      {isExpensive && <Crown className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-1.5 sm:py-2">
                    <span className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">Remaining Budget:</span>
                    <span className={cn(
                  ...
                  <div className="flex items-center justify-between py-1.5 sm:py-2">
                    <span className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">Team Slots:</span>
                ...
                {/* Key Stats Preview */}
                <div className="bg-gradient-to-br from-slate-100 to-slate-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-3 sm:p-4 md:p-5 border border-slate-200 dark:border-slate-600 shadow-md">
                  <h4 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white mb-3 sm:mb-4 flex items-center justify-center gap-2">
                    <Zap className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />
                    Key Stats
                  </h4>
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 text-center">
                    <div className="space-y-0.5 sm:space-y-1">
                      <div className="text-xl sm:text-2xl font-bold text-red-600 dark:text-red-400">{pokemon.stats.hp}</div>
                      <div className="text-[10px] sm:text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">HP</div>
                    </div>
                    <div className="space-y-0.5 sm:space-y-1">
                      <div className="text-xl sm:text-2xl font-bold text-orange-600 dark:text-orange-400">{pokemon.stats.attack}</div>
                      <div className="text-[10px] sm:text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">ATK</div>
                    </div>
                    <div className="space-y-0.5 sm:space-y-1">
                      <div className="text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400">{pokemon.stats.total}</div>
                      <div className="text-[10px] sm:text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">TOTAL</div>
                    </div>
                  </div>
                </div>
              </div>
