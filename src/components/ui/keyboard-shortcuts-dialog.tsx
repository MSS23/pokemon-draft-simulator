  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-40 flex items-center gap-2 px-3 py-2 bg-white dark:bg-card border border-border rounded-lg shadow-lg hover:shadow-xl transition-all text-sm text-muted-foreground hover:text-foreground"
